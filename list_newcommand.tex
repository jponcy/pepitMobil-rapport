...
\newcommand{\responsableMiParcours}{Arnaud Lewandoski}
\newcommand{\pepit}{\href{pepit.be}{Pepit}}
\newcommand{\pepitSite}{\href{http://pepit.be}{pepit.be}}
\newcommand{\pepitMobil}{Pépit Mobil}
\newcommand{\ulco}{\textbf{U}niversité du \textbf{L}ittoral \textbf{C}ôte d'\textbf{O}pale}
\newcommand{\siteulco}{\href{http://www.univ-littoral.fr/}{www.univ-littoral.fr}}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% macros techniques
\newcommand{\licenceDuProjet}{\href{http://www.gnu.org/licenses/quick-guide-gplv3.fr.html}{GPLv3}}
...
\newcommand{\googleDocuments}{\google{} Documents}
...
\newcommand{\jar}{\href{http://fr.wikipedia.org/wiki/JAR_(format_de_fichier)}{jar}}
